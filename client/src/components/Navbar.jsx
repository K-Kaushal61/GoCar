...
const Navbar = ({setShowLogin}) => {
  ...
  return (
    <div className={`flex items-center justify-between px-6 md:px-16 lg:px-24 x1:px-32 py-4 text-gray-600 border-b border-borderC010r relative transition-all ${location.pathname === "/" && "bg-light"}`}>
        <Link to='/'>
        ...
        items-start sm:items-center gap-4 sm:gap-8 max-sm:p-4 ${location.pathname === "/" ? "bg-light" : "bg-white"} ${open ? "max-sm:translate-0" : "max-sm:translate-x-full"}`}>
